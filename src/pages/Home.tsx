      ...
      <section className="relative overflow-hidden bg-white pt-16 pb-32">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            >
              Bergabunglah bersama {settings?.namaSekolah || 'SMP Karya Pembangunan 1 Baleendah'}. Kami berkomitmen memberikan pendidikan dasar terbaik dengan fasilitas modern dan tenaga pendidik profesional.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
              Ikuti langkah-langkah mudah berikut untuk mendaftarkan putra/putri Anda di SMP Karya Pembangunan 1 Baleendah
            </p>
          </div>
